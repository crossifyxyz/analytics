export default function resetPwdHtml({
  originUrl,
  productName,
  userAgent,
  actionUrl,
...
<head>
  ...
  <style type="text/css" rel="stylesheet" media="all">
      ...
      .button--green {
          ...
          border-right: 18px solid #1DA1F2;
          border-bottom: 10px solid #1DA1F2;
          border-left: 18px solid #1DA1F2;
      }
...
<body>
  ...
  <table class="email-wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation">
              ...
              <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                      <td class="email-masthead">
                          <a href="${originUrl}" class="f-fallback email-masthead_name">
                              ${productName}
                          </a>
                      </td>
                  </tr>
                              ...
                              <tr>
                                  <td class="content-cell">
                                      <div class="f-fallback">
                                          <h1>Hello,</h1>
                                          <p>You recently requested to reset your password for your ${productName}
                                              account. Use the button below to reset it. <strong>This password reset
                                                  is only valid for the next ${expireTime}.</strong></p>
                                          <!-- Action -->
     ...
     https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                          ...
                                          <p>For security, this request was received from User Agent
                                              <i>${userAgent}</i>.
                                              If you did not request a password reset, please ignore this email or
                                              contact support at <b>${supportMail}</b> if you have
                                              questions.
                                          </p>
                                          <p>Thanks,
